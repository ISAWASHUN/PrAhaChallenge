import{j as t}from"./jsx-runtime-D_zvdyIk.js";import{r as p}from"./index-D4lIrffr.js";import{B as I}from"./Board-B6xt9FDz.js";import{w as j,u as s,e as S}from"./index-CIfn4WAl.js";import"./Square-BV3w8_Fj.js";function T(){const[a,n]=p.useState([Array(12).fill(null)]),[e,c]=p.useState(0),o=e%2===0,W=a[e];function N(i){const r=[...a.slice(0,e+1),i];n(r),c(r.length-1)}function C(i){c(i)}const R=a.map((i,r)=>{const D=r>0?"Go to move #"+r:"Go to game start";return t.jsx("li",{children:t.jsx("button",{onClick:()=>C(r),children:D})},r)});return t.jsxs("div",{className:"game",children:[t.jsx("div",{className:"game-board",children:t.jsx(I,{xIsNext:o,squares:W,onPlay:N})}),t.jsx("div",{className:"game-info",children:t.jsx("ol",{children:R})})]})}T.__docgenInfo={description:"",methods:[],displayName:"Game"};const _={title:"Components/Game",component:T,parameters:{layout:"centered"}},l={args:{}},u={args:{},decorators:[a=>t.jsx("div",{style:{padding:"2rem",backgroundColor:"#f5f5f5",borderRadius:"8px"},children:t.jsx(a,{})})]},m={args:{},play:async({canvasElement:a})=>{const n=j(a),e=n.getAllByRole("button").filter(o=>o.className==="square");await s.click(e[0]),await s.click(e[4]),await s.click(e[1]),await s.click(e[5]),await s.click(e[2]);const c=n.getByText(/Winner: X/i);S(c).toBeInTheDocument()}},d={args:{},play:async({canvasElement:a})=>{const n=j(a),e=n.getAllByRole("button").filter(o=>o.className==="square");await s.click(e[0]),await s.click(e[5]),await s.click(e[8]),await s.click(e[2]),await s.click(e[10]),await s.click(e[9]);const c=n.getByText(/Winner: O/i);S(c).toBeInTheDocument()}};var y,v,g;l.parameters={...l.parameters,docs:{...(y=l.parameters)==null?void 0:y.docs,source:{originalSource:`{
  args: {}
